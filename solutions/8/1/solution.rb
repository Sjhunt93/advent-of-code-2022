...
class Matrix
    ...
    def probe(x,y)
        visable_left =  descend_x(x, y, 1, 0) #or  or descend_x(x,y,0,1) or descend_x(x,y,0,-1)
        ...
        return (visable_left or visable_right or visable_down or visable_up)
    end
...
trees = (grid.x_size * 2 + grid.y_size * 2) - 4
puts(trees)
for y in 1..ysize-2
    for x in 1..xsize-2
        res = grid.probe(x, y)
